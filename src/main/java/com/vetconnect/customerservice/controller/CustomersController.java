...
public class CustomersController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<CustomerResponse> updateCustomerDetails(@PathVariable int id, @RequestBody CustomerRequest customerRequest){
	...
	public ResponseEntity<List<AddressResponse>> getCustomerAddresses(@PathVariable int id){
